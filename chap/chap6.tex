...
%			\end{enumerate}
		...
		\subsection{测试用例}
			...
			\item 集成测试（Integration Test）：
				...
				\item IT1 测试用例：
					表\ref{IT1TestCase}为IT1 测试用例，测试对象为参与者商家装载于手机的商家和商品信息管理子系统（SMIMSS）的五项功能分别为添加店家帐户、添加/修改/删除店员帐户、添加/删除/修改商品信息、取得产品信息以及接收交易信息，针对上述SMIMSS的五项功能需与母系统BTMS 1.0.0交互。目的：验证［SMIMSS 1.1.0］子系统能否正确管理商家商品信息。
