	...
	\section{性能測試}
		...
		\begin{enumerate}
			...
			\item 第二次測試（2017年9月6日）：表\ref{1general}為第二次實驗數據，該次的比特幣交易法起廣播至比特幣交易緩存持的時間平均為1.918秒，標準差為0.55586秒。但為了預防雙花攻擊需要等待平均654.8秒（小於11分鐘，標準差346.63秒）的時間。
				...
				\begin{table}[!htbp]
				\centering
				\caption{第二次以Testnet 執行實驗之數據分析(2017/09/06)}
				\label{1general}
			...
			\item 第三次測試（2018年3月21日）：
				\begin{table}[!htbp]
				\centering
				\caption{第三次以Testnet 執行實驗之數據(2018年3月21日)}
				\label{2general}
				...
				\begin{table}[!htbp]
				\centering
				\caption{第三次以Testnet 執行實驗之數據分析(2018年3月21日)}
				\label{2general-1}
				\begin{tabular}{|c|c|c|}
				\hline
		...
		\begin{enumerate}
			...
			\item 第二次測試（2018年2月6日）：表\ref{2green}
			...
			\item 第三次測試（2018年3月21日）：表\ref{3green}

		\end{enumerate}
			\begin{table}[!htbp]
				\centering
				\caption{第三次以GreenAddress執行實驗之數據(2018年3月21日)}
				\label{3green}
				\begin{tabular}{|c|c|c|c|c|c|}
				\hline
				\begin{tabular}[c]{@{}c@{}}交易\\ 次數\end{tabular} & 付款時間 & \begin{tabular}[c]{@{}c@{}}進入緩存池\\ 所花時間(秒)\end{tabular} & \begin{tabular}[c]{@{}c@{}}進入緩存池\\ 時間點\end{tabular} & \begin{tabular}[c]{@{}c@{}}寫入區塊鏈\\ 所花時間(秒)\end{tabular} & \begin{tabular}[c]{@{}c@{}}寫入區塊\\ 時間點\end{tabular} \\ \hline
