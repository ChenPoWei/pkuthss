...
\chapter{相关理论与技术}
		...
		在点对点的现金系统中，首先必须先生成一个地址，在比特币的协议中有着既定的程序程序生成地址。运用到的技术包括乱数产生器（Random number generator）、非对称式加密算法Secp256k1\supercite{johnson2001elliptic}、哈希算法SHA-256\supercite{DBLP:conf/fse/KhovratovichRS12}以及Base58 编码\supercite{Base58}。接下来将详述每一个函数的运作过程以及意义，最后说明比特币交易地址生成的每一个步骤。
				...
				\hline
				算法 & 安全性 & \begin{tabular}[c]{@{}c@{}}签名\\ 大小\end{tabular} & \begin{tabular}[c]{@{}c@{}}私钥\\ 大小\end{tabular} & \begin{tabular}[c]{@{}c@{}}公钥\\ 大小\end{tabular} & \begin{tabular}[c]{@{}c@{}} 签名\\(微秒)\end{tabular} & 签名/秒 & \begin{tabular}[c]{@{}c@{}} 验证\\ (微秒)\end{tabular} & 验证/千秒 \\ \hline
				BLISS-0 & $\leq$60 bits & 3.3 kb & 1.5 kb & 3.3 kb & 0.241 & 4k & 0.017 & 59 \\ \hline
				BLISS-I & 128 bits & 5.6 kb & 2 kb & 7 kb & 0.124 & 8k & 0.03 & 33 \\ \hline
				BLISS-II & 128 bits & 5 kb & 2 kb & 7 kb & 0.48 & 2k & 0.03 & 33 \\ \hline
				BLISS-III & 160 bits & 6 kb & 3 kb & 7 kb & 0.203 & 5k & 0.031 & 32 \\ \hline
				BLISS-IV & 192 bits & 6.5 kb & 3 kb & 7 kb & 0.375 & 2.5k & 0.032 & 31 \\ \hline
				RSA-1024 & 72-80 bits & 1 kb & 1 kb & 1 kb & 0.167 & 6k & 0.004 & 91 \\ \hline
				RSA-2048 & 103-112 bits & 2 kb & 2 kb & 2 kb & 1.18 & 0.8k & 0.038 & 27 \\ \hline
				RSA-4096 & $>$128 bits & 4 kb & 4 kb & 4 kb & 8.66 & 0.1k & 0.138 & 7.5 \\ \hline
				ECDSA-160 & 80 bits & 0.32 kb & 0.16 kb & 0.16 kb & 0.058 & 17k & 0.205 & 5 \\ \hline
				ECDSA-256 & 128 bits & 0.5 kb & 0.25 kb & 0.25 kb & 0.106 & 9.5k & 0.384 & 2.5 \\ \hline
				ECDSA-384 & 192 bits & 0.75 kb & 0.37 kb & 0.37 kb & 0.195 & 5k & 0.853 & 1 \\ \hline
				\end{tabular}%
				}
				\end{table}
