...
\section{區塊鏈的實名交易監督系統設計}
	...
	\begin{enumerate}
		\item 商家必須在BRTMS註冊一個帳戶，並附有政府法規的商業證明，如圖\ref{time1}所示。
		...
		\item 商家可以自由地登錄賬戶並添加商家想要出售的產品信息，如圖\ref{time3}所示，亦可透過職工管理添加修改刪除職工信息，如圖\ref{time2}所示。
	...
	圖\ref{fig4}區塊鏈的實名交易監督系統創建步驟描述如下：
		...
		\begin{enumerate}
			\item 商家的職工將登錄到如圖\ref{fig3}所示的先前步驟創建的帳戶，以使用手持式平板電腦或智能手機訪問SMCTSS中的服務。如前所述，在能夠登錄到系統之前，商家帳戶必須由政府機構審計。
