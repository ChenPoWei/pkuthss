...
% 采用了自定义的（包括大小写不同于原文档的）字体文档名，
% 并改动 ctex.cfg 等配置文档的用户请自行加入 nofonts 选项；
...
\pkuthssinfo{
	...
	ctitle = {区块链的实名交易监督系统的设计与实现}, etitle = {Design and Realization of blockchain real-name transaction monitoring system},
	cauthor = {陈伯韦},
	eauthor = {Chen Po Wei},
	...
	cmentor = {李杰教授}, ementor = {Prof.\ Lijie},
